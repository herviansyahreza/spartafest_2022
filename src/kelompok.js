            ...
            <div className="form m-[40px] w-2/3 p-[20px] border-2 rounded-3xl bg-cyan-400" action="">
                ...
                <section class="content mt-[50px] m-[50px] p-[40px]">
                    <div class="ketua">
                        ...
                        <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="text" placeholder="Nama Tim" name="nama" id="namatim" required /><br />

                        <label className="text-left text-bold text-xl" for=""><b>Nama Ketua Team</b></label><br />
                        <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="text" placeholder="Nama Ketua Tim" name="nama" id="namaketua" required /><br />
                    ...
                    <div class="anggota">
                        ...
                        <div class="anggota1">
                            ...
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="text" placeholder="Nama Anggota 1" name="nama" id="nama1" /><br />

                            <label className="text-left text-bold text-xl" for=""><b>Nomor Induk Mahasiswa</b></label><br />
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="number" placeholder="NIM / KTM" name="nim" id="nim" /><br />

                            <label className="text-left text-bold text-xl" for=""><b>Email</b></label><br />
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="email" placeholder="Email Anggota 1" name="email" id="email" /><br />
                        </div>
                        <div class="anggota2 mt-[100px]">
                            <label className="text-left text-bold text-xl" for=""><b>Nama Anggota 2</b></label><br />
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="text" placeholder="Nama Anggota 2" name="nama" id="nama2" /><br />

                            <label className="text-left text-bold text-xl" for=""><b>Nomor Induk Mahasiswa</b></label><br />
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="number" placeholder="NIM / KTM" name="nim" id="nim" /><br />

                            <label className="text-left text-bold text-xl" for=""><b>Email</b></label><br />
                            <input className="w-full py-[15px] px-[10px] mb-[10px] bg-transparent border-b-[2px] text-black text-xl " type="email" placeholder="Email Anggota 2" name="email" id="email" /><br />
                        </div>
